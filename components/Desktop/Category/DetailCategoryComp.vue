<template>
  ...
  >
    ...
    <div
      class="relative lg:w-1/2 xs:w-full xs:h-84 lg:h-full post-left"
      v-if="category != null"
    >
      <img
    ...
    <div
      class="relative xs:py-8 xs:px-8 lg:pt-20 lg:px-16 lg:w-1/2 xs:w-full h-full overflow-y-scroll markdown-body post-right custom-scroll"
    >
      <h3 class="mb-4 font-bold text-4xl" style="color: #27211e">Book Lists</h3>
        ...
        >
          ...
          >
            ...
            <div class="pt-5 pl-8 flex flex-col xxlmin:w-1/2 xxlmax:w-full">
              <p class="font-bold" style="font-size: 19px; color: #27211e">
                {{ book.title }}
              </p>
              <p style="font-size: 15px; color: #94898d">
                by {{ book.author }}
              </p>
              <p
                class="font-bold text-sm pt-8"
                style="font-size: 17px; color: #27211e"
              >
